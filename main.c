...
#include "src/ADT/listbarang/listbarang.h"
...
#include "src/ADT/user/user.h"
#include "src/command/wordl3.h"
#include "src/command/work.h"
#include "src/command/tebakangka.h"
#include "src/ADT/worklist/worklist.h"
